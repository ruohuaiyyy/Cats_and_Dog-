...
if __name__ == '__main__':
    ...
    # 添加全连接层将输出改为2
    model_alexnet.add_module("linear", Linear(1000, 2))
    ...
    # 优化器
    optim = torch.optim.Adam(model_alexnet.parameters(), lr=0.00001)
    ...
    # 保存模型
    torch.save(model_alexnet, "model_alexnet_1.pth")
