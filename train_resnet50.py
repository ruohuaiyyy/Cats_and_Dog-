...
if __name__ == '__main__':
    ...
    for parma in model_resnet50.parameters():
    ...
    # 优化器
    optim = torch.optim.Adam(model_resnet50.fc.parameters(), lr=0.00001)

    # 使用tensorboard中的SummaryWriter类绘制模型训练loss_acc图像
    writer = SummaryWriter("logs_train_resnet")
    ...
    # 保存模型
    torch.save(model_resnet50, "model_resnet50_2.pth")
